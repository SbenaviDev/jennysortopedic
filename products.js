...
const BENEFITS = [
  { icon: "🚚", title: "Envío a todo el país", text: "Recíbelo en casa" },
  { icon: "💬", title: "Asesoría por WhatsApp", text: "Te ayudamos a elegir" },
  { icon: "🛡️", title: "Productos garantizados", text: "Calidad certificada" },
  { icon: "💳", title: "Pago contra entrega", text: "Paga al recibir" },
];
